...
const MOCK_DOCTORS: DoctorProfile[] = [
  {
    ...
    available: true,
    distance: "1.2 كم",
    bio: "طبيب عام متخصص بالرعاية الأولية والأمراض المزمنة. خبرة واسعة في الزيارات المنزلية بمنطقة الخرطوم وعلاج الحالات الحادة والمزمنة.",
    languages: ["العربية", "الإنجليزية"],
    certifications: ["بكالوريوس الطب جامعة الخرطوم", "شهادة الإسعافات الأولية"],
    avatar: "AH",
  },
  {
    id: "d2",
    name: "د. منى الأمين إبراهيم",
    ...
    languages: ["العربية", "الإنجليزية"],
    certifications: ["بورد طب الأطفال السوداني", "شهادة الرضاعة الطبيعية"],
    avatar: "MA",
  },
  {
    id: "d3",
    name: "د. عبد الرحيم النور محمد",
    ...
    available: true,
    distance: "3.5 كم",
    bio: "استشاري أمراض باطنة متخصص بالسكري وأمراض القلب والغدد الصماء. يقدم خدمة زيارة منزلية شاملة في الخرطوم وأم درمان.",
    languages: ["العربية", "الإنجليزية"],
    certifications: ["بورد الباطنة السوداني", "زمالة أمراض السكري"],
    avatar: "AN",
  },
  {
    id: "d4",
    name: "د. نوال إبراهيم حمد",
    ...
    available: false,
    distance: "4.0 كم",
    bio: "متخصصة بأمراض الجلد والتجميل والشعر. تقدم تشخيصاً دقيقاً وعلاجاً فعالاً للحالات الجلدية الشائعة في المناخ السوداني.",
    languages: ["العربية", "الإنجليزية"],
    certifications: ["بورد أمراض الجلد", "دبلوم الطب التجميلي"],
    avatar: "NI",
  },
  {
    id: "d5",
    name: "د. طارق عثمان الفكي",
    ...
    available: true,
    distance: "5.2 كم",
    bio: "جراح عظام متخصص بكسور العظام وأمراض المفاصل وآلام الظهر. يقدم خدماته في الخرطوم وبحري.",
    languages: ["العربية", "الإنجليزية"],
    certifications: ["بورد جراحة العظام السوداني", "زمالة جراحة المفاصل"],
    avatar: "TE",
  },
  {
    id: "d6",
    name: "د. هالة حمد الله أحمد",
    ...
    available: true,
    distance: "2.8 كم",
    bio: "استشارية قلبية متخصصة بتشخيص وعلاج أمراض القلب التاجية وارتفاع ضغط الدم الشائع في السودان.",
    languages: ["العربية", "الإنجليزية"],
  ...
  },
  {
    ...
    available: true,
    distance: "1.8 كم",
    bio: "متخصص بأمراض الأذن والأنف والحنجرة والشخير وأمراض الحنجرة الشائعة في المناطق المدارية.",
    languages: ["العربية"],
    certifications: ["بورد الأنف والأذن والحنجرة السوداني"],
    avatar: "SM",
  },
  {
    id: "d8",
    name: "د. سلمى عبد الله بشير",
    ...
    available: true,
    distance: "3.1 كم",
    bio: "طبيبة نفسية متخصصة بالاضطرابات المزاجية والقلق والاكتئاب. خبرة واسعة في التعامل مع ضغوط ما بعد الصدمة.",
    languages: ["العربية", "الإنجليزية"],
    certifications: ["بورد الطب النفسي السوداني", "شهادة العلاج المعرفي السلوكي"],
    avatar: "SB",
  },
];
...
const MOCK_JOBS: JobListing[] = [
  {
    ...
    facility: "منصة اكسير",
    location: "الخرطوم - جميع الأحياء",
    type: "freelance",
    specialty: "طب عام",
    salary: "50,000 - 150,000 ج.س / يوم",
    posted: "منذ يومين",
    urgent: true,
    description: "نبحث عن أطباء عامة للانضمام لمنصة اكسير وتقديم خدمات الزيارات المنزلية في الخرطوم الكبرى.",
  },
  {
    id: "j2",
    title: "ممرض/ة منزلي",
    ...
    type: "part_time",
    specialty: "التمريض",
    salary: "200,000 - 400,000 ج.س / شهر",
    posted: "منذ 3 أيام",
    urgent: true,
  ...
  },
  {
    ...
    facility: "مختبرات النيل الطبية",
    location: "الخرطوم بحري",
    type: "freelance",
    specialty: "التحاليل المخبرية",
    salary: "40,000 - 80,000 ج.س / يوم",
    posted: "منذ 5 أيام",
    urgent: false,
  ...
  },
  {
    ...
    facility: "منصة اكسير",
    location: "مدني - الخرطوم",
    type: "freelance",
    specialty: "طب الأطفال",
    salary: "80,000 - 180,000 ج.س / يوم",
    posted: "اليوم",
    urgent: true,
  ...
  },
  {
    ...
    salary: "300,000 - 600,000 ج.س / شهر",
    posted: "منذ أسبوع",
    urgent: false,
  ...
  },
  {
    ...
    facility: "صيدليات الشفاء",
    location: "أم درمان",
    type: "full_time",
    specialty: "الصيدلة",
    salary: "350,000 - 550,000 ج.س / شهر",
    posted: "منذ 4 أيام",
    urgent: false,
  ...
  },
  {
    ...
    type: "freelance",
    specialty: "الطوارئ",
    salary: "120,000 - 300,000 ج.س / يوم",
    posted: "منذ يوم",
    urgent: true,
  ...
  },
  {
    ...
    location: "الخرطوم - أم درمان",
    type: "freelance",
    specialty: "الصحة النفسية",
    salary: "50,000 - 100,000 ج.س / جلسة",
    posted: "منذ 6 أيام",
    urgent: false,
