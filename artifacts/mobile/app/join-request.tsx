...
const DISCLAIMER_CLAUSES = [
  ...
  "أتفهم وأوافق على أن منصة اكسير تعمل كوسيط تقني فحسب، وتوفّر بيئة رقمية آمنة لربط مزودي الخدمات بمتلقيها، ولا تتحمل أي مسؤولية قانونية أو مالية أو طبية تجاه أي طرف نتيجة الخدمات المقدمة عبرها.",
];
          ...
          <View>
            ...
            <View style={styles.disclaimerBox}>
              ...
              <Text style={styles.disclaimerIntro}>
                ...
                ، بصفتي مزود خدمة طبية على منصة اكسير، أُقرّ وأتعهد بما يلي:
              </Text>
            ...
            <View style={styles.legalNote}>
              ...
              <Text style={styles.legalNoteText}>
                تنبيه قانوني: منصة اكسير وسيط تقني فقط. لا تتحمل المنصة أي
